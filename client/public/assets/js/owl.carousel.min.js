...
!((a, b, c, d) => {
	...
	(e.Defaults = {
		...
		(e.Workers = [
			...
			},
			{
				...
				run: function (a) {
					...
					if (c && a.items.merge)
						while (b--) (a.css.width = this._widths[this.relative(b)]), d.eq(b).css(a.css);
		...
		(e.prototype.registerEventHandlers = function () {
			a.support.transition &&
				...
				this.settings.mouseDrag &&
					...
					this.$stage.on('dragstart.owl.core selectstart.owl.core', () => !1)),
			...
			a(c).off('.owl.core'),
				...
				((0 !== d.x && this.is('dragging')) || !this.is('valid')) &&
					...
					(Math.abs(d.x) > 3 || new Date().getTime() - this._drag.time > 300) &&
						this._drag.target.one('click.owl.core', () => !1)),
		...
		(e.prototype.clones = function (b) {
			var c = this._clones.length / 2,
				...
				f = (a) => (a % 2 == 0 ? e + a / 2 : c - (a + 1) / 2);
			return b === d
				? a.map(this._clones, (a, b) => f(b))
				: a.map(this._clones, (a, c) => (a === b ? f(c) : null));
		}),
		...
		(e.prototype.on = (a, b, c, d) => {
			a.addEventListener
				? a.addEventListener(b, c, d)
				: a.attachEvent && a.attachEvent('on' + b, c);
		}),
		(e.prototype.off = (a, b, c, d) => {
		...
		(e.prototype.isNumeric = (a) => !isNaN(Number.parseFloat(a))),
		(e.prototype.difference = (a, b) => ({ x: a.x - b.x, y: a.y - b.y })),
	...
	((a, b, c, d) => {
		var e = function (c) {
			...
			a(b).on('load', () => {
				...
				a(b).resize(() => {
					this._core.settings.autoHeight &&
						(null != this._intervalId && clearTimeout(this._intervalId),
	...
	((a, b, c, d) => {
		...
		(e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
			(e.prototype.fetch = function (a, b) {
				var c = (() =>
						a.attr('data-vimeo-id') ? 'vimeo' : a.attr('data-vzaar-id') ? 'vzaar' : 'youtube')(),
		...
		(e.Defaults = {
			...
			(e.prototype.current = function () {
				...
				return a
					.grep(
						this._pages,
						a.proxy((a, c) => a.start <= b && a.end >= b, this),
					)
					.pop();
			}),
					...
					'changed.owl.carousel': a.proxy(function (c) {
						if (c.namespace && 'position' === c.property.name) {
							var d = this._core.items(this._core.relative(this._core.current())),
								e = a.map(this._hashes, (a, b) => (a === d ? b : null)).join();
	...
	((a, b, c, d) => {
		...
		var g = a('<support>').get(0).style,
			...
			j = {
				csstransforms: () => !!e('transform'),
				csstransforms3d: () => !!e('perspective'),
				csstransitions: () => !!e('transition'),
				cssanimations: () => !!e('animation'),
			};
		j.csstransitions() &&
