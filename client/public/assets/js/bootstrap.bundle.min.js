...
!((t, e) => {
	...
	var pt = 'top',
		...
		Tt = 'popper',
		Ct = 'reference',
		Ot = vt.reduce((t, e) => t.concat([e + '-' + yt, e + '-' + wt]), []),
		xt = [].concat(vt, [bt]).reduce((t, e) => t.concat([e, e + '-' + yt, e + '-' + wt]), []),
		kt = 'beforeRead',
		Lt = 'read',
		St = 'afterRead',
		Dt = 'beforeMain',
	...
	function _e(t) {
		return t.replace(/left|right|bottom|top/g, (t) => ge[t]);
	}
	var be = { start: 'end', end: 'start' };
	function ve(t) {
		return t.replace(/start|end/g, (t) => be[t]);
	}
	function ye(t) {
		var e = $t(t);
				...
				var s =
						'clippingParents' === e
							? ((t) => {
									...
									return Wt(i) ? e.filter((t) => Wt(t) && Jt(t, i) && 'body' !== Ht(t)) : [];
								})(t)
							: [].concat(e),
					o = [].concat(s, [i]),
					r = o[0],
	...
	function Le(t, e) {
		...
		var i = e,
			...
			c = void 0 === l ? xt : l,
			h = he(n),
			d = h ? (a ? Ot : Ot.filter((t) => he(t) === h)) : vt,
		...
		fn: (t) => {
			...
			if (!e.modifiersData[n]._skip) {
				for (
					...
					var N = _e(I),
						P = [];
					if ((o && P.push(D[x] <= 0), a && P.push(D[I] <= 0, D[N] <= 0), P.every((t) => t))) {
						(T = O), (E = !1);
						break;
					}
					A.set(O, P);
	...
	function Ie(t) {
		return [pt, gt, mt, _t].some((e) => t[e] >= 0);
	}
	const Ne = {
			name: 'hide',
			enabled: !0,
				...
				h = {
					...
					setOptions: (i) => {
						...
						var r,
							...
							u = ((t) => {
								var e = He(t);
								return Ft.reduce((t, i) => t.concat(e.filter((t) => t.phase === i)), []);
							})(
