...
(() => {
	...
	(q = '<span class="odometer-value"></span>'),
		...
		(A = (a) => (0 > a ? Math.ceil(a) : Math.floor(a))),
		(t = (a) => a - x(a)),
		(C = !1),
		(B = () => {
			var a, b, c, d, e;
		...
		(m = (() => {
				...
				try {
					for (o = ['innerHTML', 'innerText', 'textContent'], i = 0, l = o.length; l > i; i++)
						(e = o[i]),
							null != this.el[e] &&
								!((a) =>
									Object.defineProperty(this.el, a, {
										get: () => {
											var b;
											return 'innerHTML' === a
												? this.inside.outerHTML
												: null != (b = this.inside.innerText)
													? b
			...
			return (
									...
									this.el.addEventListener(
										...
										() =>
											b
												...
												: ((b = !0),
													setTimeout(
														() => (this.render(), (b = !1), z(this.el, 'odometerdone')),
														0,
													),
													!0),
										!1,
					...
					return (
						...
						(b = a - this.value)
							? (v(this.el, 'odometer-animating-up odometer-animating-down odometer-animating'),
								...
								this.animate(a),
								this.startWatchingMutations(),
								setTimeout(() => (this.el.offsetHeight, r(this.el, 'odometer-animating')), 0),
								(this.value = a))
							: void 0
					);
				}),
				(a.prototype.renderDigit = () => s(d)),
				...
				(a.prototype.animateCount = function (a) {
					...
					if ((d = +a - this.value))
						return (
							...
							(g = () => {
								var i, j, k;
								return u() - f > this.options.duration
									? ((this.value = a), this.render(), void z(this.el, 'odometerdone'))
									: ((i = u() - e),
										i > b &&
											((e = u()),
											(k = i / this.options.duration),
											(j = d * k),
											(c += j),
											this.render(Math.round(c))),
										null != w ? w(g) : setTimeout(g, b));
							})()
						);
				}),
				(a.prototype.getDigitCount = () => {
					var a, b, c, d, e, f;
					for (
				...
				(a.prototype.getFractionalDigitCount = () => {
					var a, b, c, d, e, f, g;
					for (
		...
		null != document.createEventObject
			...
			: document.addEventListener(
					'DOMContentLoaded',
					() => (m.options.auto !== !1 ? m.init() : void 0),
					!1,
				),
