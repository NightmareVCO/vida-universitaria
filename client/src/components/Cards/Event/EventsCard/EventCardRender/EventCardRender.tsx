...
export default function EventCardRender({ activities, studentsGroupsData }: EventCardRenderProps) {
	return (
		<div className="row justify-content-center">
			{activities?.map((activity) => (
				<EventCard key={activity.id} activity={activity} studentsGroupsData={studentsGroupsData} />
			))}
